package com.daniel.navigationtest.ngp.featurea
...
fun CarRidesLandingScreen(
    ...
    Column(
        ...
        Text(text = "You are now At (NGP) CarRides Landing Now", modifier = Modifier.background(Color.Transparent), color = Color.Yellow, fontSize = 18.sp)
